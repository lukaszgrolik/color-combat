...
{
    private IGroundHitProvider groundHitProvider;
    ...
    {
        this.groundHitProvider = groundHitProvider;
    ...
    public void OnUpdate()
    {
        ...
        {
            if (groundHitProvider.GroundHitFound)
            {
                attackLastTime = Time.time;

                Attack(groundHitProvider.GroundHitPoint);
            }
        }
    }
